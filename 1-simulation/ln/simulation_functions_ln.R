...
# Parameters 
# alpha_pos: learning rate for updating of the feature weights subsequent to reward (i.e. correct choice)
# alpha_neg: learning rate for updating of the feature weights subsequent to punishment (i.e. incorrect choice)
...
fRL_model = function(stage, stimulus, f1, f2, f3, f4, alpha_pos, alpha_neg, beta) {
  ...
  # Choose alpha based on choice (alpha_pos if correct, alpha_neg if incorrect choice)
...
# Function for running either the ln-fRL or ln-cafRL models defined above
